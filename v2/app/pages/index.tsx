      ...
      <section id={styles.left_section}>
        ...
        <div>
          {language ? <>				<p>You might know Mario Kart, the most fun racing game series of all time!
            ...
            <p>Finally, you can face players from the whole world thanks to the <strong>multiplayer online mode</strong>! Climb the <Link href="/leaderboard">leaderboards</Link> and become world champion!</p>
            ...
            <p>Enfin, il est possible d'affronter les joueurs du monde entier grâce au <strong>mode multijoueurs en ligne</strong> ! Grimpez dans le <Link href="/leaderboard">classement</Link> et devenez champion du monde !</p>
          </>}
        </div>
